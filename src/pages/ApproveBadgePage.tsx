        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted">
              The freelancer has been notified of your response.
            </p>
            {txSignature && (
              <a
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <p className="text-base text-muted px-4">
              ...
              experience needed — we'll seamlessly create a secure wallet stack
              for you in seconds.
            </p>
          </div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="space-y-4 text-center">
          ...
          <p className="text-sm text-muted">
            By approving, you officially confirm that you worked with this
            freelancer and vouch for their work. Your endorsement will be
        ...
        <motion.div
          ...
          className="rounded-3xl glass-panel p-6 sm:p-8 space-y-6 relative overflow-hidden"
        >
        ...
        <motion.p
          variants={itemVariants}
          className="text-center text-[11px] font-semibold uppercase tracking-widest text-muted/60 mt-4"
        >
